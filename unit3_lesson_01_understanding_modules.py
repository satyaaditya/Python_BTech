...
def test_module_star_import():
    ...
    assert  set(['m4_func1','_m4_func3'])== (s3 - s2)  # what did module4 import bring in.
...
-what is a module,and its implementation
-came across new function dir,system modules
-different ways of importing and their feaures
