...
def z(input):
    ...
    for i in range(0, len(input)):
        a.append(len(input[i]))
    b.append(input[a.index(min(a))])
    b.append(input[a.index(max(a))])
    return tuple(b)
...
-types of functions and its return values
-how to create function and pass function as parameter
-features of python functions over c
"""