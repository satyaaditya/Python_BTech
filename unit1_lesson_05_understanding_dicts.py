...
def test_valid_dictionary_keys(elements="tuple with immutable elements"):
    test_dict = {}
    test_dict[1] = 1
...
-unlike tuples, dictionary can have different type of indices
-range returns a list and lisst is non hashable type
-came across some built in functons through zip,min,max
"""
