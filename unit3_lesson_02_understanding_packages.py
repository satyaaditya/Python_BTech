...
def test_package_import_failure():
    ...
    why_it_failed = "python checks for __init__.py to check whether it is a package or not,which is absent in package2"
...
-difference between types of import
-how to de import the imported things
-how package,why package,what package
"""
