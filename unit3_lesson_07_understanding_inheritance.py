...
-how classes are inherited to derive class
-additional abilities derived classes gain through inheritance
-came across super key word,issubclass and finally wwhat is inheritace
"""
