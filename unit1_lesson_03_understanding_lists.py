...
def odd_desc(count):
    ...
    """
    return sorted(range(1,count*2,2),reverse=True)
...
-came across two new functions sorted and listed
-and came to know strings are immutable while lists are mutable
-lists are somewhat more flexible than strings
"""