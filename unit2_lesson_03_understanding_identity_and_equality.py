...
- from my observation,identity satisfies if it is same object,that is why it satisfied ex: b=a;it will have same object
-equality sees for the type and if same type then value
-important::caching behaviour with small numbers that differ with large numbers
"""
