...
def test_find_builtins_that_work_on_iterables():
    funcs = ['all','any','filter','frozenset','list','map','max','min','next','reduce','sorted','sum','tuple','zip']
    assert 14 == len(funcs)
...
-to be patient while solving,
-finally all types of iterators and why iterators
_and how iterators get implemented on iterables
"""