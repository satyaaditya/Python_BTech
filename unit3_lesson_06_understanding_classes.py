...
-classes,and usage of self
-init method in classes and magic methods
-class objects,instance objects,method objects,relation of function and class
"""