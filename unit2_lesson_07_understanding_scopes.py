...
def test_scope_is_bound_at_definition_time():
    ...
    try:
        value = count
        count = 30
    except UnboundLocalError as ae: # what happens when you read a variable before initializing it?
...
https://docs.python.org/2/reference/executionmodel.html#naming
"""


three_things_i_learnt = """
-scope of a variable
-how globals and locals are treated in function
-name spaces and what they actually mean, new key word global
"""
