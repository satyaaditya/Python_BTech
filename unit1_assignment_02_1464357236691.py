...
def get_lower_to_upper_dict():
    ...
    """
    return dict(zip(string.lowercase,string.uppercase))
...
def get_encoding_dict():
    ...
    """
    return dict(set(zip(string.lowercase,range(1,27,1)))|set(zip(string.uppercase,range(1,27,1))))
