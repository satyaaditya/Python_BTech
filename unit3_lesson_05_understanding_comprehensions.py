...
def get_scrabble_scorer():
    return dict((j, scrabble_scores[i][0]) for i in range(0, len(scrabble_scores)) for j in scrabble_scores[i][1])
...
-learnt different comprehensions
-and syntactic structures of set,list,dict comprehensions
-learnt how we can  manipulate list set dict using comprehensions
"""
