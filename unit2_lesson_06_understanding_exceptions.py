...
-got clarity on control flow while exception raised and not raised
-difference in else execution with exception and without exception
-finally,difference between else and finally
"""
